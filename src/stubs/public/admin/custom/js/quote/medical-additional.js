...
const question = (num) => {
    let qn = `
        <div class="col-md-3 col-sm-12 rq">
            <label for="" class="sks-required">Month</label>
            <select class="form-select  form-select-sm" name="opmOb[]">
        ...
        <div class="col-md-2 col-sm-12 rq">
            <label for="" class="sks-required">Year</label>
            <select class="form-select form-select-sm" name="opyOb[]">
    ...
    let an = `
        <div class="col-md-4 col-sm-12 qn">
            <div class="form-group">
                ...
                <input type="text" class="form-control form-control-sm" name="opfN[]" value="">
            </div>
        </div>

        <div class="col-md-2 col-sm-12 rq">
            <label for="" class="sks-required">Birth Date</label>
            <input type="number" min="1" max="31" class="form-control form-control-sm" name="opdOb[]" value="">
        </div>
    `;
