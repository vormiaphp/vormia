								...
								<div class="col-md-4 col-sm-12">
									<div class="form-group">
										...
										<select class="form-control select2 @error('access') is-invalid @enderror" name="access[]" multiple>
											...
											@php
												$old_access = is_array(old('access')) ? old('access') : [];
											@endphp
											@foreach ($main_roles as $list)
												<option value="{{ $list->id }}" @selected(in_array($list->id, $old_access))>
													{{ $list->name }}
												</option>
											@endforeach
										</select>
						...
						<div class="row">
							<div class="col-md-12 col-sm-12">
								<div class="form-group">
									...
									<input type="text" class="form-control @error('username') is-invalid @enderror" id="" placeholder=""
